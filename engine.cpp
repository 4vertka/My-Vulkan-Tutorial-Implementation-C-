...
void HelloTriangle::pickPhysicalDevice() {
    ...
    if (deviceCount == 0) {throw std::runtime_error("failed to find GPU width vulkan support");}
...
void HelloTriangle::createTextureImage() {
    ...
    stbi_uc* pixels = stbi_load("./textures/saul.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    copyBufferToImage(stagingBuffer, textureImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texWidth));
